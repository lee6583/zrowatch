export default {
  ...
  admin: {
    ...
    userManagement: {
      ...
      subtitle: 'Current workspace Sub2API user balances',
      total: '{count} users',
      loading: 'Loading users...',
      empty: 'No matching users',
      common: { placeholder: '--', off: 'Off' },
      filters: { search: 'Search email or username', allStatuses: 'All statuses', allRoles: 'All roles' },
      status: { active: 'Active', disabled: 'Disabled' },
      roles: { user: 'User', admin: 'Admin' },
      states: { retrying: 'Recharge retry pending' },
      table: { user: 'User', status: 'Status', balance: 'Balance', warning: 'Alert threshold', recharge: 'Auto recharge', checkedAt: 'Last check', actions: 'Actions' },
      dialog: { title: 'Balance rule', warningEnabled: 'Balance alert', warningThreshold: 'Alert threshold', rechargeEnabled: 'Automatic recharge', rechargeThreshold: 'Recharge threshold', rechargeAmount: 'Recharge amount' },
      actions: { refresh: 'Refresh', configure: 'Configure', save: 'Save', cancel: 'Cancel', remove: 'Remove monitoring' },
      notices: { saved: 'Balance rule saved.', removed: 'Balance monitoring removed for this user.' },
      errors: { invalidRequest: 'Complete the enabled rule fields with valid values.', upstreamAuth: 'The current Sub2API admin session has expired. Sign in again.', upstreamRequest: 'The Sub2API user request failed. Try again later.', persistence: 'The balance rule could not be saved. Try again later.', network: 'Network request failed. Try again later.', request: 'The user management request failed. Try again later.' }
    },
    leaderboard: {
    ...
    connectionHealth: {
      ...
      fields: {
        ...
        downstreamConsume: 'Downstream Spend',
      ...
      downstreamConsumption: {
        help: 'Cumulative actual user charges for current Sub2API accounts since each upstream connection was created.',
        loading: 'Loading',
        available: 'Complete',
        partial: 'Partial data',
        empty: 'No downstream accounts to measure',
        unsupported: 'The current downstream platform does not support account usage statistics',
        unavailable: 'Downstream usage unavailable',
        accountProgress: 'Measured {success}/{total} accounts',
        accountConflict: 'The same account belongs to multiple upstream sites and was skipped',
    ...
    groupRates: {
      ...
      health: {
        ...
        settings: {
          ...
          model: 'Probe Model',
          groupInterval: 'Probe Interval (seconds)',
          groupFailureThreshold: 'Failure Threshold',
