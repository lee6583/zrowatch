...
var workspaceDeleteStatements = []workspaceDeleteStatement{
	...
	{Name: "upstream_balance_account_pauses", SQL: `DELETE FROM upstream_balance_account_pauses WHERE user_id = $1 AND admin_account_id = $2`},
	{Name: "upstream_balance_profit_cycle_accounts", SQL: `DELETE FROM upstream_balance_profit_cycle_accounts WHERE user_id = $1 AND admin_account_id = $2`},
	{Name: "upstream_balance_profit_cycles", SQL: `DELETE FROM upstream_balance_profit_cycles WHERE user_id = $1 AND admin_account_id = $2`},
	{Name: "connection_health_group_rate_monitor_actions", SQL: `DELETE FROM connection_health_group_rate_monitor_actions WHERE user_id = $1 AND admin_account_id = $2`},
	{Name: "connection_health_group_rate_monitor_cycles", SQL: `DELETE FROM connection_health_group_rate_monitor_cycles WHERE user_id = $1 AND admin_account_id = $2`},
	{Name: "connection_health_group_rate_monitor_states", SQL: `DELETE FROM connection_health_group_rate_monitor_states WHERE user_id = $1 AND admin_account_id = $2`},
	{Name: "connection_health_group_rate_monitor_overrides", SQL: `DELETE FROM connection_health_group_rate_monitor_overrides WHERE user_id = $1 AND admin_account_id = $2`},
	{Name: "connection_health_group_rate_monitor_settings", SQL: `DELETE FROM connection_health_group_rate_monitor_settings WHERE user_id = $1 AND admin_account_id = $2`},
	{Name: "connection_health_profit_priority_states", SQL: `DELETE FROM connection_health_profit_priority_states WHERE user_id = $1 AND admin_account_id = $2`},
	...
	{Name: "downstream_consumption_ledger", SQL: `DELETE FROM downstream_consumption_ledger WHERE user_id = $1 AND workspace_admin_account_id = $2`},
...
var legacyWorkspaceTables = []workspaceTableDescriptor{
	...
	{Name: "downstream_consumption_ledger", WorkspaceColumn: "workspace_admin_account_id"},
	...
	{Name: "upstream_balance_account_pauses", WorkspaceColumn: "admin_account_id"},
	{Name: "upstream_balance_profit_cycle_accounts", WorkspaceColumn: "admin_account_id"},
	{Name: "upstream_balance_profit_cycles", WorkspaceColumn: "admin_account_id"},
	{Name: "connection_health_group_rate_monitor_actions", WorkspaceColumn: "admin_account_id"},
	{Name: "connection_health_group_rate_monitor_cycles", WorkspaceColumn: "admin_account_id"},
	{Name: "connection_health_group_rate_monitor_states", WorkspaceColumn: "admin_account_id"},
	{Name: "connection_health_group_rate_monitor_overrides", WorkspaceColumn: "admin_account_id"},
	{Name: "connection_health_group_rate_monitor_settings", WorkspaceColumn: "admin_account_id"},
	{Name: "connection_health_profit_priority_states", WorkspaceColumn: "admin_account_id"},
